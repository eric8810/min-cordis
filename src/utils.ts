...
/** Resolve to `Promise`'s inner type when `T` is already a promise, else `Promise<T>`. */
...
/**
 * The [Standard Schema](https://standardschema.dev) v1 interface, inlined so
 * the core carries zero runtime dependencies. Any validator implementing this
 * (zod, valibot, arktype, …) can serve as a plugin `Config` schema.
 */
